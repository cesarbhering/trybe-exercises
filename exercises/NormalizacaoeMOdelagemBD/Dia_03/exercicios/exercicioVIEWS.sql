...
SELECT f.title, fc.category_id, c.name FROM category as c
...
SELECT a.actor_id, CONCAT(a.first_name, ' ', a.last_name) AS actor, f.title FROM actor AS a
...
SELECT a.address_id, a.address, a.district, a.city_id, c.city FROM address AS a
