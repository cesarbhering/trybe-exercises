...
const upperString = (string) => { return string.toUpperCase() };
const firstLetter = (string) => { return string.split()[0] };
const concatString = (string1, string2) => { return string1.concat(string2)};

module.exports = { upperString, firstLetter, concatString }