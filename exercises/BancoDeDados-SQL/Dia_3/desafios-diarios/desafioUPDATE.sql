...
WHERE name = 'Sci-Fi';
#Atualize o valor do aluguel para $25 de todos os filmes com duração maior que 100 minutos e que possuem
# a classificações "G" , "PG" ou "PG-13" e um custo de substituição maior que $20.
UPDATE film SET rental_rate = 25
WHERE length > 100
...
UPDATE film
SET rental_rate = (
CASE WHEN (length <= 100) THEN 10.00
